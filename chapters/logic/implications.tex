...
\setlength{\extrarowheight}{10pt}
    ...
    \begin{center}
        ...
        \includegraphics[scale=0.06,alt={Four figures with or without rain or wet grass},width=0.85\linewidth]{images/created/rainy_grass.png}
    \end{center}
    \begin{enumerate}
...
\begin{practiceprob}[Making Arguments]
    ...
    \begin{center}
        % \inputtikz{dive_bomb}
        \includegraphics[scale=0.06,alt={Four images with or without an umbrella or a zombie in a plane},width=0.85\linewidth]{images/created/dive_bomb.png}
    \end{center}
...
\begin{exposition}[More Rules and Arguments]
