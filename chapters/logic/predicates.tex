...
\begin{figure}[H]
    ...
    \includegraphics[alt={Ten by ten grid with various shapes letters and figures},width=0.9\linewidth]{images/created/tarski_world.png}
...
\begin{figure}[H]
    ...
    \includegraphics[alt={Venn diagram of two truth sets},width=0.75\linewidth]{images/created/truth_set_venn.png}
...
\begin{figure}[H]
    ...
    \includegraphics[alt={Blank venn diagram for two truth sets},width=0.75\linewidth]{images/created/empty_truth_venn.png}
