...
\end{defn}
\begin{expository}[sidebyside]{Sample Predicates}
Find values for the variables which make the predicates true or false.
    ...
    \setlength{\itemsep}{18pt}
        ...
        \item \(S(n,m): n^2>m\)\vspace{2\baselineskip}
    \end{itemize}
\tcblower
    \begin{itemize}
    \setlength{\itemsep}{18pt}
...
\begin{practice}[sidebyside]{Shapes, Colors, and Zombies, Oh My!!}
Use figure \ref{fig:Tarski} on page \pageref{fig:Tarski} to identify when these predicates are true or false.
    ...
    \setlength{\itemsep}{18pt}
        ...
        \item \(R(x):\) \(x\) is \textcolor{red!60!black}{\bfseries\em red}\vspace{2\baselineskip}
    \end{itemize}
    \tcblower
    \begin{itemize}
    \setlength{\itemsep}{18pt}
...
\begin{figure}[H]
    ...
    % Sets
        ...
        \draw (2,0) circle (2cm);
    % Labels
        \node at (0,1.5) {\large \(T_G\)};
        \node at (2,1.5) {\large \(T_H\)};
    \end{tikzpicture}
...
\begin{expository}{Quantified Predicates}
% Examples
...
\begin{practice}{Tarski's Zombies}
% Exercises
