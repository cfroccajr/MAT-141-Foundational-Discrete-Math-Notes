...
\begin{practice}[label=rainstatements]{Statements and Their Negations}
    Fill in the negation of each statement.
    \setlength{\columnsep}{0pt}
    \begin{multicols}{2}
        \begin{itemize}
            \item \(R\equiv\) ``It is raining.''
            \item \(G\equiv\) ``The grass is wet.''
            \item \(U\equiv\) ``I have an umbrella.''
        \end{itemize}
    \end{multicols}\vspace{0.5\baselineskip}
        \begin{itemize}
            \item \(\sim R\equiv\) \hrulefill\vspace{\baselineskip}
            \item \(\sim G\equiv\) \hrulefill\vspace{\baselineskip}
            \item \(\sim U\equiv\) \hrulefill\vspace{\baselineskip}
        \end{itemize}
\end{practice}
...
\newcounter{n}
\setcounter{n}{1}
\begin{practice}[label=mainimages]{Visualizing Truth Values}
    ...
    \begin{center}
        ...
        \includegraphics[]{tikz/grass_zombies.pdf}
    \end{center}
\end{practice}



\begin{practice}{Relating Statements to Sets}
    ...
    \begin{center}
        ...
        \includegraphics{tikz/venn_zombies.pdf}        
    \end{center}    
\end{practice}

\clearpage

\begin{practice}{Combinations and Modifications of Statements}
    ...
    \setlength{\itemsep}{10pt}
        \item \(U\wedge G\): \rule{\textwidth/4}{0.2pt}
        \item \(\sim(U\wedge G)\): \rule{\textwidth/4}{0.2pt}
        \item \(\sim U\wedge \sim G\): \rule{\textwidth/4}{0.2pt}
        \item \(U\vee G\): \rule{\textwidth/4}{0.2pt}
        \item \(\sim(U\vee G)\): \rule{\textwidth/4}{0.2pt}
        \item \(\sim U \vee \sim G\): \rule{\textwidth/4}{0.2pt}
    \end{enumerate}   
    \end{multicols}
\end{practice}

\begin{practice}{Negate Compound Statements}
...
\begin{defn}[Tautology and Contradiction]
    A \emph{tautology}\index{tautology} is a statement that is always true and a \emph{contradiction}\index{contradiction} is a statement that is always false.  For example, \underline{\em in the figures in practice box \ref{mainimages}}, ``the grass is green'' is a tautology since it is always true, ``there is a zombie'' is a contradiction since it is always false.
\end{defn}

\begin{practice}{True or False}
    For which pictures in practice problem \ref{mainimages} are the following sentences true?
    \begin{enumerate}
    \setlength{\itemsep}{10pt}
        \item ``The grass is green.'' \hrulefill
        \item ``There is a zombie.'' \hrulefill
        \item ``The grass is green'' \(\vee\) ``I have an umbrella.'' \hrulefill
        % \item ``The grass is green'' \(\wedge\) ``I have an umbrella.'' \hrulefill
        % \item ``There is a zombie'' \(\vee\) ``I have an umbrella.'' \hrulefill
        \item ``There is a zombie'' \(\wedge\) ``I have an umbrella.'' \hrulefill
        \item ``There is a zombie'' \(\vee\) ``the grass is green.'' \hrulefill
        \item ``There is a zombie'' \(\wedge\) ``the grass is green.'' \hrulefill
    \end{enumerate}    
\end{practice}

\begin{expository}{Some ``Basic'' Logical Rules with \(\sim,\ \wedge,\ \&\ \vee\)}
\begin{itemize}
