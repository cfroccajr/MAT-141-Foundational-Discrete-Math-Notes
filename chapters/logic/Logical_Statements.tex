...
\begin{practiceprob}[Visualizing Truth Values]\label{mainimages}
    ...
    \begin{center}
        ...
        \includegraphics[alt={Eight images with different configurations of a stick figure with out without rain or an umbrella or wet grass.},width=0.85\linewidth]{images/created/grass_zombies.png}
    \end{center}
\end{practiceprob}
...
\begin{practiceprob}[Relating Statements to Sets]
    ...
    \begin{center}
        ...
        \includegraphics[alt={Blank Venn diagram for organizing the previous images into three overlapping sets.},width=0.65\linewidth]{images/created/venn_zombies.png}        
    \end{center}    
\end{practiceprob}
