...
\begin{exposition}
    ...
    \end{align}
    Thus we can see that using ideas previously discussed we can assemble and remix statements to arrive at a conclusion.  Note, this could have been done using a truth table and looking at critical rows or using Venn diagrams; however, with four statements a truth table would have had sixteen rows or we need a Venn diagram with four overlapping sets with up to sixteen regions to consider.
\end{exposition}
...
\begin{practiceprob} Below is a proof that this is a valid argument:
    ...
    Proof:
    \begin{align}
        &\text{Steps} &&\text{Justifications}\\[\baselineskip]
