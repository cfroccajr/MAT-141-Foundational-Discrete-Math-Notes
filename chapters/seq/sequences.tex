...
\tcblower
    ...
    \includegraphics[alt={Graph showing values in a sequence},width=0.75\linewidth]{images/created/filled_out_seq_graph.png}
\end{sides}
\end{exposition}
...
\tcblower
    ...
    \includegraphics[alt={Blank graph for adding values in a sequence},width=0.75\linewidth]{images/created/empty_seq_graph.png}
\end{sides}
\index{increasing}
\end{practiceprob}
