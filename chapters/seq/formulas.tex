...
\begin{note}[Golden Ratio]
    ...
    But then, \(L=1+1/L\) or \(L^2-L-1=0\), which, as before. gives \[L=\frac{1\pm\sqrt{5}}{2}.\]
    Finally, this line of thinking gives us rough justification for the characteristic polynomial in theorem \ref{thm:distinct_roots}.
\end{note}
