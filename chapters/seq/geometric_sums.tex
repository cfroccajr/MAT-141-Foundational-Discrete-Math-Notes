...
\begin{figure}[H]
    ...
    \includegraphics[scale=0.06,alt={Visual representation of adding powers of two},width=0.85\linewidth]{images/created/powersoftwosum.png}
...
Now consider the sum of powers of 1/2.
    ...
    \begin{figure}[H]
        ...
        \includegraphics[scale=0.06,alt={Visual representation of adding powers of one half},width=0.85\linewidth]{images/created/sumofpowersofhalf.png}
...
Next consider the sum of powers of 1/4.
    ...
    \tcblower
        \begin{figure}[H]
            ...
            \includegraphics[scale=0.06,alt={Visual representation of adding powers of one quarter},width=0.85\linewidth]{images/created/sumofpowersofonequarter.png}
