...
\begin{figure}[H]
    ...
    \includegraphics[width=0.85\linewidth,alt={Example of summation notation with lables for the various components of the notation}]{images/created/summation_notation.png}
