...
\begin{figure}[H]
    \centering
    %\inputtikz{tree_def}
    \includegraphics[scale=0.24,alt={}]{images/created/tree_def.png}
...
\begin{defn}[Binary Trees]\index{binary trees}\index{tree!binary}
\hspace*{1in}
\begin{itemize}
...
\begin{figure}[H]
    ...
    \includegraphics[scale=0.24,alt={}]{images/created/trees_binary.png}
...
\begin{thm}
	...
	\includegraphics[scale=0.24,alt={}]{images/created/tree_full_binary.png}
