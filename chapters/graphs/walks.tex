...
\begin{practiceprob}
    Look at the graph in figure \ref{fig:euler-hamilton-graph} and try and find Euler or Hamilton circuits.  Do this both with and without the dashed edge.
    \begin{figure}[H]
        \centering
        % \inputtikz{graph_euler_hamilton_thms}
        \includegraphics[scale=0.18,alt={practice graph for finind Euler circuits or Hamilton circuits}]{images/created/graph_euler_hamilton_thms.png}
        \caption{Euler and Hamilton Circuits}
        \label{fig:euler-hamilton-graph}
    \end{figure}

    \begin{itemize}
        \item Hamilton Circuit w/o Dashed Line: \hrulefill
        \item Euler Circuit w/o Dashed Line: \hrulefill
        \item Euler Trail w/o Dashed Line: \hrulefill
        \item Hamilton Circuit w/ Dashed Line: \hrulefill
        \item Euler Circuit w/ Dashed Line: \hrulefill
        \item Euler Trail w/ Dashed Line: \hrulefill
    \end{itemize}
