...
\begin{center}
    ...
    \includegraphics[scale=0.24,alt={}]{images/created/graph_walk_types.png}
\end{center}    
...
\begin{figure}[H]
    ...
    \includegraphics[scale=0.24,alt={}]{images/created/graph_walk_relations.png}
...
\begin{center}
    ...
    \includegraphics[scale=0.24,alt={}]{images/created/graph_euler_pract1.png}
\end{center}
\end{practiceprob}
...
\begin{center}
    ...
    \includegraphics[scale=0.24,alt={}]{images/created/graph_euler_pract2.png}
\end{center}
\end{practiceprob}
...
\begin{figure}[H]
    ...
    \includegraphics[scale=0.24,alt={}]{images/created/graph_euler_hamilton_thms.png}
    % \includegraphics[width=0.5\linewidth]{}
...
Again try to find any Euler or Hamilton Circuits.
    ...
    \includegraphics[scale=0.24,alt={}]{images/created/graph_euler_pract3.png}
\end{practiceprob}
...
Again try to find any Euler or Hamilton Circuits.
    ...
    \includegraphics[scale=0.24,alt={}]{images/created/graph_euler_pract4.png}
\end{practiceprob}
