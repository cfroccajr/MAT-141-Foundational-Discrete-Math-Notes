...
\begin{sides}[righthand width=0.48\linewidth]
    \begin{figure}[H]
        ...
        \includegraphics[scale=0.24,alt={demonstration of graph termenology}]{images/created/label_graph.png}
...
\begin{center}
    ...
    \includegraphics[scale=0.24,alt={a complete graph}]{images/created/graph_complete.png}
\end{center}

Directed Graph (Digraph):
\begin{center}
    %\inputtikz{graph_directed}
    \includegraphics[scale=0.24,alt={a directed graph}]{images/created/graph_directed.png}
\end{center}

Bipartite Graph:
\begin{center}
    %\inputtikz{graph_bipartite}
    \includegraphics[scale=0.24,alt={a bipartite graph}]{images/created/graph_bipartite.png}
\end{center}
...
\begin{center}
    ...
    \includegraphics[scale=0.24,alt={a complete bipartite graph}]{images/created/graph_bicomplete.png}
\end{center}

Tree:
\begin{center}
    %\inputtikz{graph_tree}
    \includegraphics[scale=0.24,alt={basic example of a tree}]{images/created/graph_tree.png}
\end{center}

Binary Tree:
\begin{center}
    %\inputtikz{graph_bitree}
    \includegraphics[scale=0.24,alt={example of a binary tree}]{images/created/graph_bitree.png}
\end{center}
...
\includegraphics[scale=0.24,alt={basic graph used to practice finding degrees, vertex sets, and edge sets}]{images/created/graph_practice.png}
