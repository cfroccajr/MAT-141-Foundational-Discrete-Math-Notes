...
\begin{defn}[Relations]\index{relation}\index{cartesian product}\index{subset}
    ...
    is a relation between \(A\) and \(B\).  We normally prefer to describe the relation, for example we can describe \(L\) by \[\forall x\in A\, \forall y\in B: x\, L\, b\ \text{if and only if}\ x<y,\]
...
\begin{practiceprob}
    ...
    \end{equation*}
    Rewrite \(M_7\) in set notation and list five ordered pairs of integers in \(M_7\).  Then try to show that \(M_7\) is reflexive, symmetric and transitive, i.e. it is an equivalence relation.
    \vspace{0.3\textheight}
\end{practiceprob}\index{relation!reflexive}\index{relation!symmetirc}\index{relation!transitive}\index{relation!equivalence relation}
...
\begin{practiceprob}
    ...
    \end{equation*}
    Rewrite \(L\) in set notation and list five ordered pairs of integers in \(L\).  Try to show that \(L\) is antisymmetric and transitive, then give examples showing that it is not reflexive or symmetric and so is not an equivalence relation.
    \vspace{0.3\textheight}
\end{practiceprob}
...
\begin{practiceprob}
    ...
    \end{equation*}
    Rewrite \(D\) in set notation and list five ordered pairs of integers in \(D\).  Try to show that \(D\) is antisymmetric, then give examples showing that it is not reflexive, symmetric, or transitive and so is not an equivalence relation.
    \vspace{0.3\textheight}
\end{practiceprob}
...
\begin{practiceprob}
    ...
    \end{equation*}
    Rewrite \(B_\epsilon\) in set notation and list five ordered pairs of real number in \(B_\epsilon\) in the case when \(\epsilon=0.5\), i.e. \(B_{0.5}\).  Try to show that \(B_{0.5}\) is reflexive and symmetric, then give examples showing that it is not transitive and so is not an equivalence relation.
    \vspace{0.3\textheight}
\end{practiceprob}
...
\begin{practiceprob}
    ...
    \end{quote}
    For example \((their,tear)\in W\), but \((there,tear)\not\in W\).  Try to write \(W\) in set notation and list five ordered pairs of words in \(W\) and five pairs not in \(W\).  Try to show that \(W\) is reflexive, symmetric, and transitive, i.e. that it is an equivalence relation.
    \vspace{0.3\textheight}
\end{practiceprob}
...
\begin{exposition}{Subset Relation}
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \includegraphics[scale=0.06,alt={subset relation mapped out as a graph}]{images/created/setrelationdiagram.png}
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \includegraphics[scale=0.06,alt=subset relation mapped out as a hasse diagram]{images/created/setrelationhassediagram.png}
        \caption{Hasse Diagram of Subset Relation}
        \label{fig:hassesubsetrelation}        
    \end{subfigure}
    \end{figure}

    In the first diagram each time an element \(x\) relates to an element \(y\) we draw an arrow form \(x\) to \(y\).  The second diagram is drawn assuming we have a partial-ordering and the physically lowest value in the diagram is the \emph{minimal value} in the partial-ordering, the loops are implied, and so are arrows going from lower values to higher.
...
\begin{sides}[lefthand width=0.6\textwidth]
    ...
    \tcblower
        ...
        \includegraphics[scale=0.06,alt={graph of a reflexive and symmetric relation}]{images/created/relationgraph_1.png}
\end{sides}    
\end{practiceprob}
...
\tcblower
        ...
        \includegraphics[scale=0.06,alt={graph of a partial ordering},width=0.7\linewidth]{images/created/relationgraph_2.png}
\end{sides}
\end{practiceprob}
...
\tcblower
        ...
        \includegraphics[scale=0.06,alt={graph of a only symmetric relation}]{images/created/relationgraph_3.png}
\end{sides}
\end{practiceprob}
...
\tcblower
        ...
        \includegraphics[scale=0.06,alt={graph of a reflexive only relation}]{images/created/relationgraph_4.png}
\end{sides}
\end{practiceprob}
...
\tcblower
        ...
        \includegraphics[scale=0.06,alt={graph of a trivial equivalence relation}]{images/created/relationgraph_5.png}
\end{sides}
\end{practiceprob}
...
\begin{defn}[Equivalence Class]
    ...
    \begin{figure}[H]
        ...
        \includegraphics[scale=0.06,alt={the set of integers partitioned by the relation mod 5}]{images/created/partition_of_Z.png}
...
\includegraphics[scale=0.06,alt={graph of an equivalence relation with four singleton equivalence classes}]{images/created/eq_class_diagram.png}
\end{practiceprob}
...
\includegraphics[scale=0.06,alt={graph of an equivalence relation with one equivalence class}]{images/created/eq_class_diagram2.png}
\end{practiceprob}
...
\includegraphics[scale=0.06,alt={graph of an equivalence relation with three equivalence classes}]{images/created/eq_class_diagram3.png}
\end{practiceprob}
