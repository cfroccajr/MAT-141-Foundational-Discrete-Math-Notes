...
\begin{defn}[Set Notations]\index{set roster notation}\index{set builder notation}
    ...
    \begin{figure}[H]
        ...
        \includegraphics[alt={Diagram describing components of set builder notation},width=0.55\linewidth]{images/created/setbuilder.png}
...
\begin{exposition}[Universal Sets, Compliments, and Visualization]\index{universal set}\index{set complement}\index{subset}\index{Venn diagram}
    ...
    \begin{figure}[H]
        ...
        \includegraphics[alt={Venn diagram of sets A and B listed above.},width=0.33\linewidth]{images/created/twosetvenn.png}
...
\begin{defn}[Products of Sets]\index{Cartesian product}\index{ordered pair}
    ...
    \begin{figure}[H]
        ...
        \includegraphics[alt={Cartesian product of the sets A and B},width=0.35\linewidth]{images/created/cartesianproduct.png}
...
\begin{defn}[Subsets and Power Sets]\index{subset}\index{power set}
    ...
    \begin{figure}[H]
        ...
        \includegraphics[alt={Diagram of set inclusions in the power set of the set B},width=0.65\linewidth]{images/created/powersetinclusiondiagram.png}
