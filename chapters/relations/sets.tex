...
\begin{defn}[Set Notations]\index{set roster notation}\index{set builder notation}
    ...
    \begin{figure}[H]
        ...
        \includegraphics[scale=0.24,alt={Diagram describing components of set builder notation},width=0.55\linewidth]{images/created/setbuilder.png}
...
\begin{practiceprob}
    Given \(C=\left\{n\middle|n\in\bbZ\wedge -5\leq n\leq5\right\}\) and\newline \(D=\left\{-2,-3,-5,-7,-11,-13,-17,-19\right\}\) find the following:
        \begin{itemize}
            \item \(C\cup D=\left\{\phantom{\rule{280pt}{15pt}}\right\}\)
            \item \(C\cap D=\left\{\phantom{\rule{280pt}{15pt}}\right\}\)
            \item \(C\setminus D=\left\{\phantom{\rule{280pt}{15pt}}\right\}\)
            \item \(D\setminus C=\left\{\phantom{\rule{280pt}{15pt}}\right\}\)
        \end{itemize}
\end{practiceprob}
\begin{practiceprob}
    Given \(V=\left\{a,e,i,o,u,y\right\}\) of vowels and\newline \(C=\left\{b,c,d,f,g,h,j,k,l,m,n,p,q,r,s,t,v,w,x,y,z\right\}\) of consonants find the following:
        \begin{itemize}
            \item \(V\cup C=\left\{\phantom{\rule{280pt}{15pt}}\right\}\)
            \item \(V\cap C=\left\{\phantom{\rule{280pt}{15pt}}\right\}\)
            \item \(C\setminus V=\left\{\phantom{\rule{280pt}{15pt}}\right\}\)
            \item \(V\setminus C=\left\{\phantom{\rule{280pt}{15pt}}\right\}\)
        \end{itemize}
\end{practiceprob}
...
\begin{exposition}[Universal Sets, Compliments, and Visualization]\index{universal set}\index{set complement}\index{subset}\index{Venn diagram}
    ...
    \begin{figure}[H]
        ...
        \includegraphics[scale=0.24,alt={Venn diagram of sets A and B listed above.},width=0.33\linewidth]{images/created/twosetvenn.png}
...
\begin{defn}[Products of Sets]\index{Cartesian product}\index{ordered pair}
    ...
    \begin{figure}[H]
        ...
        \includegraphics[scale=0.24,alt={Cartesian product of the sets A and B},width=0.35\linewidth]{images/created/cartesianproduct.png}
...
\begin{defn}[Subsets and Power Sets]\index{subset}\index{power set}
    ...
    \begin{figure}[H]
        ...
        \includegraphics[scale=0.24,alt={Diagram of set inclusions in the power set of the set B},width=0.65\linewidth]{images/created/powersetinclusiondiagram.png}
